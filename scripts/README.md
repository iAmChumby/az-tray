...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\install.ps1 -Version v0.1.5
```
...
bash ./scripts/install.sh --Version v0.1.5
```
